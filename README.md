...
grug is a modding language with one job: make your mods immortal. Mods written today aim to still run on whatever software embeds them in 100 years. Minecraft mods written for Beta 1.7.3 (from 2011) will automatically run in the latest version of the game.
