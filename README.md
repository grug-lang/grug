...
High-quality LLM-generated PRs are **only** welcome for issues labeled `good first issue`. They do not need to be assigned to you first, since these issues are written in enough detail to make the PRs easy to review. AI-generated PRs must disclose which model was used.
